...
import Controller.TransaksiPopup;
import Controller.simpanTransaksi;
...
import javax.swing.JOptionPane;
    ...
    public class TambahTransaksiView extends javax.swing.JFrame {
        ...
        private simpanTransaksi simpanTransaksi = new simpanTransaksi();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            TransaksiPopup.tampilkanPopupPembayaran(harga, jumlah);

            simpanTransaksi.handleSimpan(jTextField1, jTextField2, jTextField3, jTextField4, this);

        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Harga dan jumlah harus berupa angka!", "Input Error", JOptionPane.ERROR_MESSAGE);
        }
